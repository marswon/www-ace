	...
	<div class="page-content">
			...
			<div class="widget-body">
                ...
                lines:false,"
						...
						<button class="btn btn-info" id="btn-search"
							authority="${pageContext.request.contextPath}/actProdefCategory/findActProdefCategoryList.do">
							 <i
					...
					<div id="toolbar" class="toolbar">
						...
						<button class="btn btn-info" id="btn-view-add"
							authority="${pageContext.request.contextPath}/actProdefCategory/insertActProdefCategory.do">
							 <i
								class="ace-icon fa fa-plus-square  align-middle bigger-125 icon-on-right"></i>
						</button>
						<button class="btn btn-info" id="btn-view-edit"
							authority="${pageContext.request.contextPath}/actProdefCategory/updateActProdefCategory.do">
							 <i
								class="ace-icon fa fa-edit  align-middle bigger-125 icon-on-right"></i>
						</button>
						<button class="btn btn-warning" id="btn-view-del"
							authority="${pageContext.request.contextPath}/actProdefCategory/deleteActProdefCategoryByActProdefCategoryId.do">
							 <i
		...
		<div id="cc-west" class="easyui-west" data-options="region:'west',split:true" title="我的树" style="width:200px;">
		 <ul id="tt" class="easyui-tree" data-options="
               url: '${pageContext.request.contextPath}/actProdefCategory/selectTreeList.do',
                method: 'get',
                animate: true,
                lines:true,
...
<div id="mm" class="easyui-menu" style="width:120px;">
	...
	<script
		src="${pageContext.request.contextPath}/content/service/actProdefCategory/config.js?version=${cfg.version}"></script>
	<script
		src="${pageContext.request.contextPath}/content/service/actProdefCategory/model.js?version=${cfg.version}"></script>
	<script
		src="${pageContext.request.contextPath}/content/service/actProdefCategory/controller.js?version=${cfg.version}"></script>
	<script
		src="${pageContext.request.contextPath}/content/service/actProdefCategory/view.js?version=${cfg.version}"></script>
