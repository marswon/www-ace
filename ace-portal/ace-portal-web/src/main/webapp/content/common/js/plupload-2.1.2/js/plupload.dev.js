...
var plupload = {
	...
	*/
	...
	/**
	 * A way to prekernel what runtime will be choosen in the current environment with the
	 * specified settings.
	 *
	 * @method prekernelRuntime
	 * @static
	 * @param {Object|String} config Plupload settings to check
	 * @param {String} [runtimes] Comma-separated list of runtimes to check against
	 * @return {String} Type of compatible runtime
	 */
	prekernelRuntime : function(config, runtimes) {
		var up, runtime;
...
plupload.Uploader = function(options) {
	...
	function calc() {
		...
		for (i = 0; i < files.length; i++) {
			...
			if (file.size !== undef) {
				...
				// Since we cannot prekernel file size after resize, we do opposite and
	...
	function onUploadFile(up, file) {
		...
		// make sure we start at a prekernelable offset
		if (file.loaded) {
